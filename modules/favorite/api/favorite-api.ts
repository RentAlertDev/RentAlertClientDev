...
export async function getFavorites(params: GetFavoritesParams) { const response = await httpClient.get<FavoriteApiItem[] | FavoriteApiItem | FavoritesApiPage>(FAVORITES_API, { params }); return mapFavoritesResponse(response.data) }
